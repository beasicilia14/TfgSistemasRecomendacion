...
algorithm_paths = [
    "merge\\algorithms\\Recommendations\\RandomRecommendationsNewYork.txt",
    "merge\\algorithms\\Recommendations\\PopularityRecommendationsNewYork.txt",
    "merge\\algorithms\\Recommendations\\KNNRecommendations_K20NewYork.txt",
    "merge\\algorithms\\Recommendations\\KNNRecommendations_K30NewYork.txt",
    "merge\\algorithms\\Recommendations\\KNNRecommendations_K60NewYork.txt",
]

validation_data_path = "subsets\\NewYork_US_validation.txt"
train_data_path = "merge/NewYork_USmerged_train.txt"
k = 10
