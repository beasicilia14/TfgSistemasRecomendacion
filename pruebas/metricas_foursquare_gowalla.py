...
rec_paths = [
    "pruebas//RecomendacionesFoursquareGowallaNewYork//RandomRecomNewYork.txt",
    "pruebas//RecomendacionesFoursquareGowallaNewYork//RandomMidpointRerankedRecommendationsNewYork.txt",
    "pruebas//RecomendacionesFoursquareGowallaNewYork//PopularityRecommendationsNewYork.txt",
    "pruebas//RecomendacionesFoursquareGowallaNewYork//PopularityMidpointRerankedRecommendationsNewYork.txt",
    "pruebas//RecomendacionesFoursquareGowallaNewYork//KNN_k120RecommendationsNewYork.txt",
    "pruebas//RecomendacionesFoursquareGowallaNewYork//KNN_k120MidpointRerankedRecommendationsNewYork.txt",
    "pruebas//RecomendacionesFoursquareGowallaNewYork//KNN_MidpointRecommendations_k120NewYork.txt"

    ]


validation_data_path = "subsets//NewYork_US_test.txt"
train_data_path = "merge/NewYork_USFoursquareGowalla_train.txt"
cutoff = 10
