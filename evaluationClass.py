...
with open("subsets/NewYork_US_validation.txt") as filevalidation: 
    for line in filevalidation: 
        ...
        #random
        objeto_rand.recomendar(pois,user, 20, city, "Recomendaciones")
        #popularity
        objeto_pop.recomendar(pois,user, 20, city, scores,"Recomendaciones")
        #knn
        objeto_knn.recomendar(userSquaredSum, user_poi_scores, user, 20, city, "Recomendaciones")
